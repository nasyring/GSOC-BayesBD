fitContImage = function(image, gamma.fun = NULL, center = NULL, inimean, nrun, nburn, J, ordering_mu, ordering_sigma, mask = NULL, slice, outputAll){
	...
	if(is.string(image)){
		...
		output = BayesBDnormal(obs, inimean, nrun, nburn, J,  ordering_mu, ordering_sigma, mask, slice, outputAll)
		...
		output = BayesBDnormal(image, inimean, nrun, nburn, J,  ordering_mu, ordering_sigma, mask, slice, outputAll)
