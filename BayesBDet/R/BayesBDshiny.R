...
ui = fluidPage(
	...
	numericInput(inputId = "center", label = "If using image data from a file, input the X-coordinate and Y-coordinate of the reference point interior to the boundary corresponding to the file data.", value = 0, min = NA, max = NA, step = NA,
  	width = NULL),
  	numericInput(inputId = "center", label = "Y-coordinate of the reference point.", value = 0, min = NA, max = NA, step = NA,
  	width = NULL),
